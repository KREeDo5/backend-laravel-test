...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * analyser: по умолчанию l5-swagger ставит ReflectionAnalyser только
             * с AttributeAnnotationFactory — docblock-аннотации @OA игнорируются.
             * Добавляем DocBlockAnnotationFactory, чтобы описания из docblock'ов
             * работали (и атрибуты, и docblock-аннотации).
             *
             * ВНИМАНИЕ: объект в конфиге несовместим с `config:cache`.
             *
